...
export default {
	//blub: "bla",  //doesn't recognize wrong option type
	corePlugins: {
		preflight: true, // set to false to disable css normalize
	},
	plugins: [
		// can be done with CSS: see app.css
	...
	theme: {
		extend: {
			...
			// taken from https://versoly.com/versoly-ui/getting-started/quickstart
